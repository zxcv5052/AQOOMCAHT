...
const User_chat_personal = require('../controllers/user_chat_personal')
 ...
 *         schema:
 *           type: integer
 *     description: Get User from User ID
 *     produces:
 *      - application/json
 *     responses:
 *       200:
 ...
 *     parameters:
 *
 *     description: Delete User ( user_chat_personal )
 *     produces:
 *      - application/json
 *     responses:
 *       200:
